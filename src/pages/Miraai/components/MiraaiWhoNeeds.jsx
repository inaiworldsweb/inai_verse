  ...
  return (
    <section className="relative min-h-screen bg-black text-white flex items-center justify-center pt-20 pb-0 lg:py-0 px-5 overflow-hidden">
      <div className="w-full max-w-7xl mx-auto text-center">
        ...
        <h2 className="text-[1.5625rem] lg:text-[2.5rem] font-bold tracking-[1px] [font-stretch:700%] mb-12 lg:mb-5">
        ...
        {!isMobile ? (
          ...
          <div className="flex -mb-20 flex-col gap-12 items-center">
            ...
            <motion.div
              ...
              className="py-6"
            >
              <p className="text-[0.75rem] lg:text-[1.125rem] leading-relaxed max-w-[320px] mx-auto opacity-90 text-[#ccc]">
        ...
        >
          <p className="text-[#ccc] text-[0.75rem] lg:text-[1.125rem] mt-25 md:mt-15 max-w-4xl mx-auto leading-relaxed px-4">
