                ...
                */}
                ...
                <div className="miraai-pin sticky top-10 min-h-screen flex flex-col items-center justify-start px-4 sm:px-6 overflow-hidden pt-12 md:pt-16 lg:pt-20">
                    ...
                    <div className="w-full flex flex-col items-center justify-center">
                        ...
                        <p className="mb-12 text-[#ccc] text-center tracking-tight leading-none text-[0.875rem] md:text-[1rem] lg:text-[1.3125rem] z-10">
                    ...
                    <div className="walk-container flex flex-col md:grid md:grid-cols-2 gap-6 sm:gap-8 md:gap-6 lg:gap-14 items-start w-full max-w-6xl relative z-10">
                        ...
                        <div ref={consoleRef} className=" md:mb-6 w-full flex justify-center lg:justify-start order-2 lg:order-1">
