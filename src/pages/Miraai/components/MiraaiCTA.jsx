...
const QuestionCard = ({ icon, question, index }) => {
    ...
    return (
        <motion.div
            ...
            className="group bg-[#111111] w-full max-w-[380px] min-h-[160px] mx-auto p-6 md:p-8 rounded-[2rem] flex flex-col items-center justify-center text-center relative overflow-hidden border border-white/5 transition-all duration-300 hover:-translate-y-1 hover:border-white/20 hover:bg-[#161616] hover:shadow-[0_22px_70px_rgba(0,0,0,0.55)]"
        >
...
const MiraaiCTA = () => {
    return (
        <section style={{ fontFamily: 'Inter, sans-serif' }} className="py-20 px-4 sm:px-6 lg:px-20 bg-black flex justify-center">
            <div className="w-full max-w-4xl bg-[#050505] rounded-[3rem] p-8 md:p-12 border border-white/5 relative overflow-hidden">
                {/* Background Glow */}
