            ...
            <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-20">
                <div className="text-center mb-16 md:mb-24">
                    <motion.h2
                        ...
                        className="text-[25px] md:text-[40px] font-black mb-6 tracking-tighter text-white"
                    >
                            ...
                            <div key={index} className={`relative flex flex-col md:flex-row items-center justify-between ${step.side === 'right' ? 'md:flex-row-reverse' : ''}`}>
                                ...
                                <div className="relative md:absolute md:left-1/2 md:top-1/2 md:-translate-x-1/2 md:-translate-y-1/2 z-30 mb-8 md:mb-0">
                                    <motion.div
                                        ...
                                        viewport={{ once: true }}
                                        className="w-14 h-14 rounded-full bg-white text-black flex items-center justify-center font-black text-xl shadow-[0_0_30px_rgba(255,255,255,0.2)] border-4 border-black"
                                    >
                                        {step.number}
                                    </motion.div>
                                </div>
                                ...
                                >
                                    ...
                                    <h3 className="text-[23px] md:text-[38px] font-black mb-4 tracking-tight text-white leading-tight">
                                        {step.title}
                                    </h3>
                                    <h4 className="text-white/40 font-bold mb-6 tracking-[0.15em] uppercase text-[13px] md:text-[18px]">
                                        {step.subtitle}
                                    </h4>
