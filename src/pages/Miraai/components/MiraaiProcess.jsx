      ...
      <div className="max-w-[1400px] mx-auto px-4 sm:px-6 lg:px-20">
        ...
        <div className="text-center mb-12">
          ...
          <motion.p
            ...
            className="text-white/40 text-[15px] md:text-[25px] max-w-3xl mx-auto font-medium"
          >
            ...
            {steps.map((step, index) => (
              ...
              >
                ...
                <motion.div
                  ...
                  className="w-full md:w-[42%] aspect-square rounded-[2rem] overflow-hidden bg-[#0A0A0A] border border-white/5 relative group p-[2px]"
                >
                ...
                >
                  ...
                  <h4 className="text-white/40 font-bold mb-10 tracking-[0.15em] uppercase text-[15px] md:text-[15px] ">
                    {step.subtitle}
                  </h4>

                  <p className="text-white/30 leading-relaxed text-[15px] md:text-[20px]  max-w-xl">
                    {step.description}
                  </p>
                </motion.div>
