                ...
                <div className="flex flex-col h-full pt-8 pb-8 px-8">
                    ...
                    <div className="flex items-center gap-4 mb-12">
                        ...
                        <div className="flex items-center gap-3">
                            ...
                            <span className="text-xl font-medium text-white/90 whitespace-nowrap">Privacy Policy</span>
                        </div>
                    </div>
                    ...
                    <nav className="flex-1 min-h-0 space-y-1 overflow-y-auto pr-2 custom-scrollbar">
                        {sections.map((section) => (
                            ...
                            >
                                <span className={`font-mono text-[10px] w-5 h-5 rounded-md flex items-center justify-center border ${activeSection === section.id ? 'border-white/20 bg-white/10' : 'border-white/5 bg-white/[0.02]'}`}>{section.number}</span>
                        ...
                        <div className="prose prose-invert max-w-none [&_h2]:font-normal [&_h3]:font-normal">
                            ...
                            <section id="categories" className="mb-12 scroll-mt-24">
                                ...
                                <div className="space-y-6">
                                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                                        <h3 className="text-[15px] md:text-[25px] mb-4 text-white font-['Inter']">3.1 Personal Information</h3>
                                    ...
                                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                                        <h3 className="text-[15px] md:text-[25px] mb-4 text-white font-['Inter']">3.2 Sensitive Personal Data</h3>
                                    ...
                                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                                        <h3 className="text-[15px] md:text-[25px] mb-4 text-white font-['Inter']">3.3 AI Inputs, Outputs & Content</h3>
                                    ...
                                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                                        <h3 className="text-[15px] md:text-[25px] mb-4 text-white font-['Inter']">3.4 Automatically Collected Information</h3>
                                    ...
                                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                                        <h3 className="text-[15px] md:text-[25px] mb-4 text-white font-['Inter']">3.5 Cookies, Pixels & Tracking Technologies</h3>
                            ...
                            <section id="sharing" className="mb-12 scroll-mt-24">
                                ...
                                <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                                    <p className="text-white mb-4">We do not sell personal data.</p>
                            ...
                            <section id="payments" className="mb-12 scroll-mt-24">
                                ...
                                <div className="space-y-6">
                                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                                        <h3 className="text-[15px] md:text-[25px] mb-4 text-white font-['Inter']">11.1 Paid Products & Services</h3>
                                        <p className="text-white/80">
                                    ...
                                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                                        <h3 className="text-[15px] md:text-[25px] mb-4 text-white font-['Inter']">11.2 Payment Information</h3>
                                    ...
                                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                                        <h3 className="text-[15px] md:text-[25px] mb-4 text-white font-['Inter']">11.3 Multiple Products & Variable Pricing</h3>
                                    ...
                                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                                        <h3 className="text-[15px] md:text-[25px] mb-4 text-white font-['Inter']">11.4 Refunds, Cancellations & Adjustments</h3>
                                    ...
                                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                                        <h3 className="text-[15px] md:text-[25px] mb-4 text-white font-['Inter']">11.5 Failed or Disputed Payments</h3>
                                    ...
                                    <div className="bg-white/5 backdrop-blur-sm border border-white/10 rounded-2xl p-8">
                                        <h3 className="text-[15px] md:text-[25px] mb-4 text-white font-['Inter']">11.6 Invoices & Records</h3>
                                        <p className="text-white/80">
