...
//             {/* Main Content */}
//             <main className="md:pl-[280px] min-h-screen flex items-center justify-center px-6">
...
//                         INAi Verse is proudly recognized among the best AI companies building today's next
//                         generation of AI. We help with innovation in business powered by machine learning,
//                         deep learning, computer vision, and natural language processing that is changing the
//                         real-world impact.
//                     </p>

//                     {/* CTA Button */}
//                     <button className="bg-white text-black px-8 py-3 rounded-full font-semibold hover:bg-gray-200 transition-all duration-200 hover:scale-105 transform">
//                         Get Started
//                     </button>
