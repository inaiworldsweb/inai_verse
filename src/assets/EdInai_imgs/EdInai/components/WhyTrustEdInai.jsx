      ...
      <div className="max-w-5xl mx-auto relative">
        ...
        <div className="hidden md:block relative min-h-[580px]">
          ...
          <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 z-40">
            <motion.div
              ...
              className="w-28 h-28 bg-white rounded-full flex items-center justify-center shadow-[0_0_80px_rgba(255,255,255,0.3)]"
            >
            ...
            {trustPoints.map((point) => (
              ...
              >
                <motion.div
                  ...
                  className="bg-[#0a0a0a]/80 border border-white/10 w-[280px] py-6 px-5 rounded-xl backdrop-blur-lg shadow-2xl text-center hover:border-white/40"
                >
        ...
        <div className="md:hidden flex flex-col items-center gap-5">
          ...
          {trustPoints.map((point) => (
            <div
              key={point.id}
              className="w-full bg-white/5 border border-white/10 p-2 rounded-2xl text-center active:bg-white/10 transition"
            >
