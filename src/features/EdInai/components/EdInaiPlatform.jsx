...
const EdInaiPlatform = () => {
  ...
  return (
    <section className="edinai-platform bg-black min-h-screen flex flex-col items-center justify-center px-4 py-12">
      <div className="max-w-6xl w-full flex flex-col items-center space-y-3">
        {/* Header Section */}
        <div className="flex items-center justify-center flex-col mb-5">
          <h1 className="mb-1">Inside the Ed-INAI AI Education Platform</h1>
        ...
        <div className="flex flex-col items-center w-full">
          ...
          {/* Learn More Button */}
          <button className="bg-white text-black font-semibold px-10 py-3 rounded-full hover:bg-gray-200 transition-all duration-300 mt-6 text-base md:text-lg">
            Learn more
          </button>
        </div>
      </div>
