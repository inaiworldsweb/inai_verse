...
const WhatIsEdInai = ({ id }) => {
  ...
  return (
    <section
      id={id}
      className="w-full py-9 md:py-12 bg-black text-white min-h-[70vh] flex px-4 lg:px-0 items-center justify-center"
    >
      {/* Main Container: Right corners are 0 */}
      <div className="max-w-6xl w-full bg-[#0a0a0a] rounded-[10px]  overflow-hidden border border-gray-800 flex flex-col lg:flex-row items-stretch shadow-2xl">
        ...
        <div className="w-full lg:w-1/2">
          <div className="relative h-full min-h-[300px] md:min-h-[400px]">
            <img
              ...
              className="w-full h-full scale-105 object-cover rounded-[10px] rounded-r-none"
            />
          </div>
        </div>
