  ...
  return (
    <>
      ...
      {isOpen && (
        ...
        >
          ...
          >
            ...
            <div className="pt-2 px-6 flex justify-center md:flex">
              <Link to="/">
                <img
                  src={logoImage}
                  alt="Logo"
            ...
            <div className="p-6 bg-white/5 border-t md:hidden border-white/10 space-y-2">
              <Link
                to="/edinai-student"
                className="flex items-center gap-3 w-full  bg-white/10 hover:bg-white/20 text-white p-2 rounded-xl transition-all font-medium text-sm shadow-lg shadow-blue-900/20"
                onClick={() => setIsOpen(false)}
              >
                <UserCircle size={18} />
                Student Portal
              ...
              <Link
                to="/edinai-admin"
                className="flex items-center gap-3 w-full bg-white/10 hover:bg-white/20 text-white p-2 rounded-xl transition-all border border-white/10 font-medium text-sm"
                onClick={() => setIsOpen(false)}
              >
      ...
      <aside className="hidden lg:flex border-r border-white/30 lg:flex-col w-[280px] bg-black p-6 xl:p-8 h-screen fixed left-0 top-0 z-50 overflow-y-auto">
        ...
        <div className="mt-auto md:hidden pt-6 border-t border-white/10 space-y-2">
          <Link
            to="/edinai-student"
