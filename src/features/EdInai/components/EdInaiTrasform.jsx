...
const EdInaiTrasform = ({ id }) => {
  return (
    <section id={id} className="w-full py-9 md:py-12 px-4">
      <div className="max-w-6xl mx-auto relative overflow-hidden rounded-[2rem] min-h-[250px] md:min-h-[350px] flex items-center justify-center text-center p-6 md:p-16">
        ...
        <div className="relative z-20 w-full max-w-4xl mx-auto">
          ...
          <div className="flex justify-center">
            <div className="group relative flex items-center gap-2 bg-white/[0.10] hover:bg-white/[0.12] text-white border border-white/10 hover:border-white/20 rounded-[8px] text-xl font-medium transition-all duration-300 active:scale-95 shadow-lg shadow-black/20">
