      ...
      <div className="max-w-6xl w-full flex flex-col gap-12">
        ...
        <div className="relative flex flex-col items-center">
          <div className="relative w-full flex items-center justify-center min-h-[300px]">
            ...
            <button
              onClick={movePrev}
              className="absolute left-0 z-10 p-3 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-white transition-all active:scale-90"
              aria-label="Previous"
            >
            ...
            <button
              onClick={moveNext}
              className="absolute right-0 z-10 p-3 rounded-full bg-white/5 hover:bg-white/10 border border-white/10 text-white transition-all active:scale-90"
              aria-label="Next"
            >
