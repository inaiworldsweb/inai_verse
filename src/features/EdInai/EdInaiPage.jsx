...
const futureHighlights = [
    ...
    },
    {
        ...
        description:
            "Students can learn anytime through on-demand sessions, AI-generated study materials, and instant question supportâ€”beyond classroom hours.",
        image: ready247Img,
    },
    {
...
const EdInaiPage = () => {
    ...
    // Calculation Logic:
    // 1. Mobile par 6 cards move karne ke liye -430vw kaafi hai.
    // 2. Desktop par 6 cards (350px width + 32px gap) ke liye -1500px to -1600px perfect hai.
    ...
    return (
        <div className="flex flex-col lg:flex-row bg-black text-white">
            ...
            <aside className="hidden lg:flex lg:flex-col w-[280px] bg-black p-6 xl:p-8 sticky top-0 h-screen overflow-y-auto">
                ...
                <div className="max-w-[1200px] mx-auto px-4 sm:px-6 lg:px-8">
                    ...
                    <section className="min-h-[calc(100vh-80px)] flex flex-col justify-center py-8 md:py-0">
                        ...
                        <p className="max-w-[930px] mx-auto text-sm sm:text-base leading-relaxed text-white/80 text-center px-2 capitalize tracking-normal">
                            Ed-INAI is an advanced AI-powered education platform where virtual
                            AI teachers conduct live, interactive lectures for schools and
                            colleges across India. Experience the next generation of AI
                    ...
                    <section
                        ...
                        id="teach-in-every-way-your-students-want-to-learn"
                    >
                    ...
                    {/* Height 250vh rakhi hai taaki jaldi niche scroll ho jaye */}
    ...
    < div className = "flex items-center" >
        <motion.div
            style={{ x }}
            // pl-0 ensure karta hai ki pehla card left se shuru ho
            // Gap ko consistent rakha hai calculations ke liye
            className="flex gap-8 pl-0 items-center"
        >
            {futureHighlights.map(({ title, description, image }, index) => (
                <article
                    key={index}
                    // Desktop width fix rakhi hai (350px) taaki calculation galat na ho
                    className="group relative h-[400px] w-[85vw] md:h-[480px] md:w-[350px] flex-shrink-0 bg-[#0A0A0A] rounded-[30px] p-6 border border-white/10"
                >
                    {/* Image Area */}
                    <div className="relative h-[55%] w-full rounded-[20px] overflow-hidden mb-6 bg-[#111]">
                        <img
                            src={image}
                            alt={title}
    ...
    {/* Minimal Footer */ }
    < div className = "w-full py-6 opacity-20 text-center" >
            <div className="h-[1px] w-20 bg-white mx-auto mb-2" />
            <p className="text-white text-[8px] tracking-[0.4em] uppercase">End of Highlights</p>
        </div >
    </div >
</section >
