  ...
  const HeroSection = () => (
    <section className="min-h-[85vh] flex flex-col items-center justify-center relative overflow-hidden bg-black py-20 px-6">
      ...
      <div className="relative z-10 text-center max-w-6xl mx-auto">
        ...
        >
          Experience the next generation of learning with cloud-native,
          scalable, and intelligent automated systems.
        </motion.p>
        <motion.div
          initial={{ opacity: 0, y: 20 }}
          animate={{ opacity: 1, y: 0 }}
    ...
    const steps = [
      {
        ...
        description:
          "Register your institution, add contact details, upload branding, and set admin roles. This builds your secure portal foundation.",
        image: step1Img,
      },
      {
        number: "2",
        ...
        description:
          "Upload subjects, chapters, resources, and assessment content. Ed-INAI converts this material into structured modules and aligned lecture flows.",
        image: step2Img,
      },
      {
        number: "3",
        ...
        description:
          "Use the built-in scheduler to set timings, select batches, choose delivery mode, and attach materials. Configure reminders and interaction settings as needed.",
        image: step3Img,
      },
      {
        number: "4",
        ...
        description:
          "The platform conducts sessions, manages queries, generates notes, records sessions, and updates analytics in real time. Admins can monitor progress or adjust parameters anytime.",
        image: step4Img,
      },
    ];
            ...
            <div className="space-y-4">
              {steps.map((step, index) => (
                <div
                  ...
                  className={`relative pl-12 pb-16 border-l-2 transition-all duration-500 ${
                    activeStep >= index ? "border-blue-500" : "border-gray-700"
                  }`}
                >
    ...
    const integrations = [
      {
        ...
        description:
          "Seamlessly connect with popular Learning Management Systems like Moodle, Canvas, and Blackboard.",
        icon: "📚",
      ...
      },
      {
        ...
        description:
          "Integrate with Zoom, Google Meet, or Microsoft Teams for live interactive sessions.",
        icon: "🎥",
      ...
      },
      {
        ...
        description:
          "Get detailed insights and analytics on student performance and engagement.",
        icon: "📊",
        features: [
          "Real-time Analytics",
          "Custom Reports",
      ...
      },
      {
        ...
        description:
          "Easily upload and manage your educational content in one place.",
        icon: "📂",
          ...
          >
            <div className="flex space-x-6 px-4">
              {integrations.map((integration, index) => (
                <div
                  key={index}
                  className={`flex-shrink-0 w-80 p-6 rounded-2xl border transition-all duration-300 ${
                    activeTab === index
    ...
    const useCases = [
      {
        ...
        description:
          "Transform traditional classrooms with AI-powered personalized learning experiences for students of all grade levels.",
        image: k12Img,
      },
      {
        title: "Higher Education",
        description:
          "Enhance university and college education with scalable, intelligent learning solutions for higher education institutions.",
        image: collegeImg,
      },
      {
        title: "Coaching Centers",
        description:
          "Deliver consistent, high-quality instruction across multiple locations with our AI teaching assistant.",
        image: coachingImg,
      },
      {
        title: "Corporate Training",
        description:
          "Streamline employee training and development with customizable learning paths and automated assessments.",
        image: corporateImg,
      },
    ];
    ...
    const UseCaseCard = ({ title, description, image }) => {
      ...
      return (
        ...
        >
          ...
          />
          <div
            className={`absolute inset-0 bg-gradient-to-t from-black via-black/20 to-transparent transition-opacity duration-500 ${isOpen ? "opacity-100" : "opacity-80"}`}
          ></div>
          <div className="absolute inset-x-0 bottom-0 p-6 flex flex-col justify-end">
            ...
            <div
              className={`transition-all duration-500 ease-in-out ${isOpen ? "max-h-32 opacity-100" : "max-h-0 opacity-0"} overflow-hidden`}
            >
            ...
            <div
              className={`flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center transition-all duration-300 ${isOpen ? "bg-white text-black" : "bg-white/20 text-white backdrop-blur-sm"}`}
            >
              {isOpen ? (
                <svg
                  className="w-4 h-4"
        ...
        <div className="max-w-7xl mx-auto">
          <div className="text-center mb-16">
            ...
            <p className="text-xl text-gray-400 max-w-3xl mx-auto">
              Discover how our AI teaching assistant can transform education
